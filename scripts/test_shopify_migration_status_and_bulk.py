...
# send_shopify_migration_email's own send/skip/error logic via
# _run_shopify_migration_bulk_send, not that env gate (see
# scripts/test_security_webhook_ratelimit_env_gate.py for that), so force
# it explicitly here to keep exercising the actual send path regardless of
# what ENVIRONMENT happens to be in whatever shell runs this script.
